...
- link:docs/doc_tech.adoc[Document technique]
- link:docs/doc_user.adoc[Document utilisateur]
...
- **25/09/2024** : de 9h30 à 12h30 → https://github.com/HugoTHOLLON/StreetCompleteSAE_S5/tree/master/docs/ODJ-CR/CR-TT-25-09-25.pdf[Lien vers le CR]
